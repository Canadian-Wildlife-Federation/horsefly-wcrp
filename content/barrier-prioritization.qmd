...
A primary outcome of the WCRP will be the rehabilitation of barriers to connectivity in the Horsefly River watershed. To achieve the goals in this plan, it is necessary to identify a suite of barriers that, if rehabilitated, will provide access to a minimum of `r gain` key habitat (@tbl-table16).
...
Out of the `r inter_num` on the intermediate list, 16 require further field assessment before selection as a final barrier to pursue for rehabilitation: 
