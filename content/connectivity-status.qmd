...
df = pd.DataFrame({"Goal #": [1,2],
                   "Goal": ["By 2040, the percent (%) of total linear habitat accessible to anadromous salmon will increase from 91% to 96% within the Horsefly River watershed (i.e., reconnect at least 19.45 km of habitat).",
