...
#| label: tbl-1
#| tbl-cap: "Table 1: Focal fish species in the Horsefly River watershed. The Secwepemctsín and Western common and scientific species names are provided."
#| warning: false
#| echo: false
...
```{r tbl2a, echo = FALSE, results = 'asis'}
#| label: tbl2a
#| tbl-cap: "Table 2: Chinook Salmon population assessments in the Horsefly River watershed. Conservation Unit assessments (a) were undertaken by the Pacific Salmon Foundation (2025). Designated Unit assessments (b) were undertaken by the Committee on the Status of Endangered Wildlife in Canada (COSEWIC 2018).<br> A"
#| warning: false
#| echo: false
source("Rscripts/table_formatting.R")
library("flextable")

data <- read.csv("data/table2a.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
```{r tbl2b, echo = FALSE, results = 'asis'}
#| label: tbl2b
#| tbl-cap: "B"
#| warning: false
#| echo: false
...
data <- read.csv("data/table2b.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
...
```{r tbl3a, echo = FALSE, results = 'asis'}
#| label: tbl3a
#| tbl-cap: "Table 3: Coho Salmon population assessments in the Horsefly River watershed. Conservation Unit assessments (a) were undertaken by the Pacific Salmon Foundation (2025). Designated Unit assessments (b) were undertaken by the Committee on the Status of Endangered Wildlife in Canada (COSEWIC 2016).<br> A"
#| warning: false
#| echo: false
source("Rscripts/table_formatting.R")
library("flextable")

data <- read.csv("data/table3a.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
```{r tbl3b, echo = FALSE, results = 'asis'}
#| label: tbl3b
#| tbl-cap: "B"
#| warning: false
#| echo: false
...
data <- read.csv("data/table3b.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
...
```{r tbl4a, echo = FALSE, results = 'asis'}
#| label: tbl4a
#| tbl-cap: "Table 4: Sockeye Salmon population assessments in the Horsefly River watershed. Conservation Unit assessments were undertaken by the Pacific Salmon Foundation (2025). Designated Unit assessments (b) were undertaken by the Committee on the Status of Endangered Wildlife in Canada (COSEWIC 2017).<br> A"
#| warning: false
#| echo: false
source("Rscripts/table_formatting.R")
library("flextable")

data <- read.csv("data/table4a.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
```{r tbl4b, echo = FALSE, results = 'asis'}
#| label: tbl4b
#| tbl-cap: "B"
#| warning: false
#| echo: false
...
data <- read.csv("data/table4b.csv", check.names=FALSE)
ft <- flextable(data)
ft <- format_flextable(ft)
ft
```
