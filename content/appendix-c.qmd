...
![Figure 5: Theories of Change model developed by the planning team for the actions identified under Strategy 1: Crossing Rehabilitation in the Horsefly River watershed. ](images/Fig7_ToC.png){fig-cap-location="bottom"}

![Figure 6: Theories of Change model developed by the planning team for the actions identified under Strategy 2: Lateral Barrier Rehabilitation in the Horsefly River watershed. ](images/Fig8_ToC.png){fig-cap-location="bottom"}

![Figure 7: Theories of Change model developed by the planning team for the actions identified under Strategy 3: Dam Rehabilitation in the Horsefly River watershed. ](images/Fig9_ToC.png){fig-cap-location="bottom"}

![Figure 8: Theories of Change model developed by the planning team for the actions identified under Strategy 4: Barrier Prevention in the Horsefly River watershed. ](images/Fig10_ToC.png){fig-cap-location="bottom"}
